...
import static meetingschedulesystem.MeetingScheduleSystem.peopleArrayList;
...
public class AddPerson extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     MeetingMenu access = new MeetingMenu();
     Person person = new Person(fName,lName, pNum);
     peopleArrayList.add(person);
     System.out.print(person);
     
     
    model1.addElement(person);
    access.PersonJList.setModel(model1);
